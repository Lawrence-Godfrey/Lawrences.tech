    ...
    return (
        <div className="ml-48 mr-48">
            ...
            lg:text-4xl dark:text-white">Privacy
                Policy</h1>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Last updated: March 05, 2023</p>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">This Privacy Policy describes Our policies
            ...
            <h2>Definitions</h2>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">For the purposes of this Privacy Policy:</p>
            <ul>
                <li>
            ...
            <h3>Personal Data</h3>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">While using Our Service, We may ask You to
            ...
            <h3>Usage Data</h3>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Usage Data is collected automatically when
                using the Service.</p>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Usage Data may include information such as
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">When You access the Service by or through a
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">We may also collect information that Your
                browser sends whenever You visit our Service or when You access
                the Service by or through a mobile device.</p>
            <h3>Information from Third-Party Social Media Services</h3>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company allows You to create an account
                and log in to use the Service through the following
                Third-party Social Media Services:</p>
            <ul>
                <li>Google</li>
                <li>GitHub</li>
            </ul>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">If You decide to register through or
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">We use both Session and Persistent Cookies
            ...
            <ul>
                <li>
                    ...
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Purpose: These Cookies are essential
                ...
                <li>
                    ...
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Administered by: Us</p>
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Purpose: These Cookies identify if
                ...
                <li>
                    ...
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Type: Persistent Cookies</p>
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Administered by: Us</p>
                    <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Purpose: These Cookies allow us to
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">For more information about the cookies we
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company may use Personal Data for the
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">We may share Your personal information in
                the following situations:</p>
            <ul>
                <li><strong className="font-semibold text-gray-900 dark:text-white">With Service Providers:</strong> We
                    may share Your personal information with Service
                    Providers to monitor and analyze the use of our Service, to contact You.
                </li>
                <li><strong className="font-semibold text-gray-900 dark:text-white">For business transfers:</strong> We
                ...
                <li><strong className="font-semibold text-gray-900 dark:text-white">With business partners:</strong> We
                    may share Your information with Our business partners to
                    offer You certain products, services or promotions.
                </li>
                <li><strong className="font-semibold text-gray-900 dark:text-white">With other users:</strong> when You
                ...
                <li><strong className="font-semibold text-gray-900 dark:text-white">With Your consent</strong>: We may
                    disclose Your personal information for any other purpose
                    with Your consent.
                </li>
            </ul>
            <h2>Retention of Your Personal Data</h2>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company will retain Your Personal Data
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company will also retain Usage Data for
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Your information, including Personal Data,
                ...
                jurisdiction.</p>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Your consent to this Privacy Policy followed
                by Your submission of such information represents Your
                agreement to that transfer.</p>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company will take all steps reasonably
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">You have the right to delete or request that
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">You may update, amend, or delete Your
                ...
                provided to Us.</p>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Please note, however, that We may need to
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Under certain circumstances, the Company may
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">The Company may disclose Your Personal Data
            ...
            lg:text-4xl dark:text-white">Children&apos;s
                Privacy</h1>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">Our Service does not address anyone under
            ...
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">We may update Our Privacy Policy from time
            ...
            <h1 className="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl
             lg:text-4xl dark:text-white">Contact
                Us</h1>
            <p className="mb-3 font-light text-gray-800 dark:text-gray-400">If you have any questions about this Privacy
                Policy, You can contact us:</p>
            <ul>
