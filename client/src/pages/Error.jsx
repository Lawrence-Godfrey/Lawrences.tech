...
const Error = ({ statusCode, title, detail }) => {
    return (
                ...
                <div>
                    ...
                    dark:bg-gray-900 hover:bg-gray-100 dark:text-gray-200 dark:border-gray-700">
                        ...
                        <button onClick={() => window.location.href = '/'}
                            className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors
                    duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500
                    dark:bg-blue-600">
                        Take me home
                        </button>
                    </div>
